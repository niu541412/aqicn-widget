        ...
        ! function(e, n) {
            ...
            function j(t, e, n, r) {
                var i = t._subscribers,
                    o = i.length;
                t._onerror = null, i[o] = e, i[o + A] = n, i[o + x] = r, 0 === o && t._state && u(O, t)
            }
            ...
            function L(e, n, r, i) {
                ...
                if (o) {
                    if ((a = function(t, e) {
                        ...
                        }(r, i)) === q ? (s = !0, u = a.error, a.error = null) : c = !0, n === a) return void C(n, new TypeError("A promises callback cannot return that same promise."))
                } else a = i, c = !0;
                n._state !== _ || (o && c ? E(n, a) : s ? C(n, u) : e === A ? k(n, a) : e === x && C(n, a))
            }
            var P = 0;
            ...
            var I = function() {
                function t(t, e) {
                    this._instanceConstructor = t, this.promise = new t(b), this.promise[w] || D(this.promise), r(e) ? (this.length = e.length, this._remaining = e.length, this._result = new Array(this.length), 0 === this.length ? k(this.promise, this._result) : (this.length = this.length || 0, this._enumerate(e), 0 === this._remaining && k(this.promise, this._result))) : C(this.promise, new Error("Array Methods must be provided an Array"))
                }
                return t.prototype._enumerate = function(t) {
                    ...
                    if (r === y) {
                        var i = T(t);
                        if (i === g && t._state !== _) this._settledAt(t._state, e, t._result);
            ...
            var Q = function() {
                function t(e) {
                    this[w] = P++, this._result = this._state = void 0, this._subscribers = [], b !== e && ("function" != typeof e && function() {
