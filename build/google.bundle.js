! function(t) {
        ...
        o = function() {
            ...
            return t.prototype.getAqiText = function(t, e) {
                ...
                var n = function(t) {
                    ...
                    r = "aqivalues" + e,
                    o = chrome.i18n.getMessage(r).split(",");
                return console.log("labels:", r, "->", o), o[n(t = o[n(t)])].trim()
    ...
    var i = function() {
        ...
        return t.prototype.cityObject = function() {
            ...
            var n = this,
                r = "on" + t + "Update";
            chrome.runtime.onMessage.addListener(function(o, i, a) {
                o.method == r ? e(n.updateData(t, o.aqi)) : console.log("Received unknown message:", o.method)
            }), chrome.runtime.sendMessage({
                method: "load" + t
            }, function(r) {
                e(n.updateData(t, r))
    ...
    var r = function() {
        ...
        return t.prototype.c = function(e, n, r, o) {
            var i;
            if (void 0 === n && (n = null), void 0 === r && (r = null), void 0 === o && (o = null), n && "string" != typeof n && (o = r, r = n, n = null), i = "svg:" == e.substr(0, 4) ? document.createElementNS("http://www.w3.org/2000/svg", e.substr(4)) : document.createElement(e), n && (i.className = n), r)
                for (var a in r) i.style[a] = r[a];
            return o && (i.innerHTML = o), this.node && this.node.appendChild(i), new t(i)
    ...
    (function(e, n) {
        ...
        ! function(e, n) {
            ...
            function E(e, n, r) {
                n.constructor === e.constructor && r === g && n.constructor.resolve === y ? function(t, e) {
                    e._state === A ? k(t, e._result) : e._state === x ? C(t, e._result) : j(e, void 0, function(e) {
                        return S(t, e)
                    }, function(e) {
                        return C(t, e)
                    })
                }(e, n) : r === q ? (C(e, q.error), q.error = null) : void 0 === r ? k(e, n) : t(r) ? function(t, e, n) {
                    u(function(t) {
                        var r = !1,
                            o = function(t, e, n, r) {
                                try {
            ...
            function k(t, e) {
                t._state === _ && (t._result = e, t._state = A, 0 !== t._subscribers.length && u(O, t))
            }

            function C(t, e) {
                t._state === _ && (t._state = x, t._result = e, u(M, t))
            }

            function j(t, e, n, r) {
                var o = t._subscribers,
                    i = o.length;
                t._onerror = null, o[i] = e, o[i + A] = n, o[i + x] = r, 0 === i && t._state && u(O, t)
            }
            ...
            function O(t) {
                var e = t._subscribers,
                    n = t._state;
                if (0 !== e.length) {
                    for (var r = void 0, o = void 0, i = t._result, a = 0; a < e.length; a += 3) r = e[a], o = e[a + n], r ? L(n, r, o, i) : o(i);
            ...
            function L(e, n, r, o) {
                ...
                if (i) {
                    if ((a = function(t, e) {
                        ...
                        }(r, o)) === q ? (s = !0, u = a.error, a.error = null) : c = !0, n === a) return void C(n, new TypeError("A promises callback cannot return that same promise."))
                } else a = o, c = !0;
                n._state !== _ || (i && c ? S(n, a) : s ? C(n, u) : e === A ? k(n, a) : e === x && C(n, a))
            }
            var I = 0;
            ...
            var D = function() {
                function t(t, e) {
                    this._instanceConstructor = t, this.promise = new t(b), this.promise[w] || P(this.promise), r(e) ? (this.length = e.length, this._remaining = e.length, this._result = new Array(this.length), 0 === this.length ? k(this.promise, this._result) : (this.length = this.length || 0, this._enumerate(e), 0 === this._remaining && k(this.promise, this._result))) : C(this.promise, new Error("Array Methods must be provided an Array"))
                }
                return t.prototype._enumerate = function(t) {
                    ...
                    if (r === y) {
                        var o = T(t);
                        if (o === g && t._state !== _) this._settledAt(t._state, e, t._result);
                    ...
                    var r = this.promise;
                    r._state === _ && (this._remaining--, t === x ? C(r, n) : this._result[e] = n), 0 === this._remaining && k(r, this._result)
            ...
            var Q = function() {
                function t(e) {
                    this[w] = I++, this._result = this._state = void 0, this._subscribers = [], b !== e && ("function" != typeof e && function() {
            ...
            return Q.prototype.then = g, Q.all = function(t) {
            ...
            }, Q.resolve = y, Q.reject = function(t) {
                var e = new this(b);
                return C(e, t), e
    ...
    o.nextTick = function(t) {
        ...
        s.push(new p(t, e)), 1 !== s.length || l || u(h)
    ...
    ! function() {
        ...
        e.checkOption("google").then(function(n) {
            if (n) {
                ...
                } else console.log("This is not google landing page...")
            }
        })
    }()
}]);