! function(t) {
        ...
        ! function(e, n) {
            ...
            function E(e, n, r) {
                n.constructor === e.constructor && r === g && n.constructor.resolve === y ? function(t, e) {
                    e._state === A ? M(t, e._result) : e._state === q ? k(t, e._result) : j(e, void 0, function(e) {
                        return C(t, e)
                    }, function(e) {
                        return k(t, e)
                    })
                }(e, n) : r === x ? (k(e, x.error), x.error = null) : void 0 === r ? M(e, n) : t(r) ? function(t, e, n) {
                    s(function(t) {
                        var r = !1,
                            i = function(t, e, n, r) {
                                try {
            ...
            function C(t, e) {
                t === e ? k(t, new TypeError("You cannot resolve a promise with itself")) : ! function(t) {
                    var e = typeof t;
            ...
            function M(t, e) {
                t._state === b && (t._result = e, t._state = A, 0 !== t._subscribers.length && s(O, t))
            }

            function k(t, e) {
                t._state === b && (t._state = q, t._result = e, s(S, t))
            }

            function j(t, e, n, r) {
                var i = t._subscribers,
                    o = i.length;
                t._onerror = null, i[o] = e, i[o + A] = n, i[o + q] = r, 0 === o && t._state && s(O, t)
            }
            ...
            function L(e, n, r, i) {
                ...
                if (o) {
                    if ((a = function(t, e) {
                        ...
                        }(r, i)) === x ? (c = !0, s = a.error, a.error = null) : u = !0, n === a) return void k(n, new TypeError("A promises callback cannot return that same promise."))
                } else a = i, u = !0;
                n._state !== b || (o && u ? C(n, a) : c ? k(n, s) : e === A ? M(n, a) : e === q && k(n, a))
            }
            var P = 0;
            ...
            var Q = function() {
                function t(t, e) {
                    this._instanceConstructor = t, this.promise = new t(_), this.promise[w] || D(this.promise), r(e) ? (this.length = e.length, this._remaining = e.length, this._result = new Array(this.length), 0 === this.length ? M(this.promise, this._result) : (this.length = this.length || 0, this._enumerate(e), 0 === this._remaining && M(this.promise, this._result))) : k(this.promise, new Error("Array Methods must be provided an Array"))
                }
                return t.prototype._enumerate = function(t) {
                    ...
                    if (r === y) {
                        var i = T(t);
                        if (i === g && t._state !== b) this._settledAt(t._state, e, t._result);
                    ...
                    var r = this.promise;
                    r._state === b && (this._remaining--, t === q ? k(r, n) : this._result[e] = n), 0 === this._remaining && M(r, this._result)
            ...
            var I = function() {
                function t(e) {
                    this[w] = P++, this._result = this._state = void 0, this._subscribers = [], _ !== e && ("function" != typeof e && function() {
            ...
            return I.prototype.then = g, I.all = function(t) {
            ...
            }, I.resolve = y, I.reject = function(t) {
                var e = new this(_);
                return k(e, t), e
    ...
    e.bgcolor = o, e.fgcolor = a, e.getWidget = function(t, e) {
        var n = moment(t.time.v),
            ...
            u = t.rtsettings.lang;
        "cn" == u ? u = "zh-CN" : "hk" == u ? u = "zh-TW" : "jp" == u ? u = "ja" : "kr" == u && (u = "ko"), moment.locale(u);
        ...
        return e && (f.float = "right"), l.c("span", "waqi-widget-aqi", f).c("span").t(t.aqi.toString()), e && ("tiny" != s && (l.c("div", {
            color: "#aaa",
            marginTop: "3px"
        }).c("small").t(n.format("LLL")), "small" != s && (l.c("div", {
            ...
            try {
                for (var s = 24 - moment(t.time.v).hour(), u = 0, c = {}, l = ["PM2.5", "PM10", "O3", "time"], f = 0; f < l.length; f++) {
